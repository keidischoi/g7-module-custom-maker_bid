...
{
    private const NAV_SRC = '/api/modules/custom-maker_bids/assets/nav.js?v=0.10.24';
    private const FORM_SRC = '/api/modules/custom-maker_bids/assets/form.js?v=0.10.24';
    private const PAGE_SRC = '/api/modules/custom-maker_bids/assets/page.js?v=0.10.24';
    private const FORM_CSS = '/api/modules/custom-maker_bids/assets/form.css?v=0.10.24';
    private const ADMIN_CSS = '/api/modules/custom-maker_bids/assets/admin.css?v=0.10.24';
    private const ADMIN_JS = '/api/modules/custom-maker_bids/assets/admin.js?v=0.10.24';
