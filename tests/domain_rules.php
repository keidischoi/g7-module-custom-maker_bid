...
expectTrue('members mode is 모두', BidRules::allowLabel('members') === '모두');
...
expectTrue('company-kind can bid company mode', BidRules::canBid(true, true, BidRules::ALLOW_COMPANY, false, 'company'));
expectFalse('individual cannot bid company mode', BidRules::canBid(true, true, BidRules::ALLOW_COMPANY, false, 'individual'));
expectTrue('individual can bid individual mode', BidRules::canBid(true, true, BidRules::ALLOW_INDIVIDUAL, false, 'individual'));
expectTrue('plain member can bid individual mode', BidRules::canBid(true, false, BidRules::ALLOW_INDIVIDUAL, false, null));
expectFalse('company-kind cannot bid individual mode', BidRules::canBid(true, true, BidRules::ALLOW_INDIVIDUAL, false, 'company'));
