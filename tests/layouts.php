...
expectTrue('admin.css listbox is dark and visible', str_contains($adminCss, 'background: #1e293b') && str_contains($adminCss, 'color: #f8fafc') && str_contains($adminCss, 'data-scroll-locked'));
