...
expectTrue('nav cache bust 0.10.29', str_contains($nav, 'nav.js?v=0.10.29'));
expectTrue('form.js cache bust 0.10.29', str_contains($nav, 'form.js?v=0.10.29'));
expectTrue('form.css cache bust 0.10.29', str_contains($nav, 'form.css?v=0.10.29'));
expectTrue('admin.css cache bust 0.10.29', str_contains($nav, 'admin.css?v=0.10.29'));
expectTrue('admin.js cache bust 0.10.29', str_contains($nav, 'admin.js?v=0.10.29'));
expectTrue('cmb_maker_nav cache bust 0.10.29', str_contains((string) file_get_contents($root.'/resources/layouts/user/cmb_maker_nav.json'), 'nav.js?v=0.10.29'));
...
expectTrue('form.js injects form.css', str_contains($formJs, 'form.css?v=0.10.29'));
...
expectTrue('page.js ensures list card classes', str_contains($pageJs, 'cmb-list-item') && str_contains($pageJs, 'ensureFormCss') && str_contains($pageJs, 'form.css?v=0.10.29'));
...
expectTrue('listener injects admin.css via _admin_base', str_contains($nav, 'cmb_maker_admin_css') && str_contains($nav, 'admin.css?v=0.10.29'));
expectTrue('listener injects admin.js via _admin_base', str_contains($nav, 'cmb_maker_admin_js') && str_contains($nav, 'admin.js?v=0.10.29'));
