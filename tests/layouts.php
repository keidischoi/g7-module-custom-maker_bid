...
expectTrue('admin.css sizes G7 Select via host not body:has', str_contains($adminCss, '.cmb-admin-select-host') && str_contains($adminCss, '.cmb-admin-select-host-lg') && str_contains($adminCss, '[role="combobox"]') && str_contains($adminCss, 'white-space: nowrap') && str_contains($adminCss, 'width: max-content') && ! str_contains($adminCss, 'body:has(.cmb-admin-select') && ! str_contains($adminCss, '--radix-select-trigger-width'));
...
expectTrue('admin.js sizes host triggers and portaled listboxes', str_contains($adminJs, 'cmb-admin-select-host') && str_contains($adminJs, 'cmb-admin-listbox') && str_contains($adminJs, 'nowrap') && str_contains($adminJs, 'MutationObserver'));
