...
expectTrue('nav cache bust 0.10.30', str_contains($nav, 'nav.js?v=0.10.30'));
expectTrue('form.js cache bust 0.10.30', str_contains($nav, 'form.js?v=0.10.30'));
expectTrue('form.css cache bust 0.10.30', str_contains($nav, 'form.css?v=0.10.30'));
expectTrue('admin.css cache bust 0.10.30', str_contains($nav, 'admin.css?v=0.10.30'));
expectTrue('admin.js cache bust 0.10.30', str_contains($nav, 'admin.js?v=0.10.30'));
expectTrue('cmb_maker_nav cache bust 0.10.30', str_contains((string) file_get_contents($root.'/resources/layouts/user/cmb_maker_nav.json'), 'nav.js?v=0.10.30'));
...
expectTrue('form.js injects form.css', str_contains($formJs, 'form.css?v=0.10.30'));
...
expectTrue('page.js ensures list card classes', str_contains($pageJs, 'cmb-list-item') && str_contains($pageJs, 'ensureFormCss') && str_contains($pageJs, 'form.css?v=0.10.30'));
...
expectTrue('search-fix sends G7 bearer token', str_contains($searchFix, 'auth_token') && str_contains($searchFix, 'Authorization') && str_contains($searchFix, 'G7Core.api'));
expectTrue('search-fix shows hold chip for admin context', str_contains($searchFix, 'viewerLooksAdmin') && str_contains($searchFix, "getAuthType() === 'admin'") && str_contains($searchFix, 'adminChipFlags'));
...
expectTrue('listener injects admin.css via _admin_base', str_contains($nav, 'cmb_maker_admin_css') && str_contains($nav, 'admin.css?v=0.10.30'));
expectTrue('listener injects admin.js via _admin_base', str_contains($nav, 'cmb_maker_admin_js') && str_contains($nav, 'admin.js?v=0.10.30'));
...
expectTrue('admin jobs filter includes disputed', str_contains($adminJobsIndex, '"value": "disputed"') && str_contains($adminJobsIndex, '분쟁조정'));
$list = (string) file_get_contents($root.'/resources/layouts/user/jobs_list.json');
