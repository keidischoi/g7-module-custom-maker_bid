...
expectTrue('module version is 0.10.28', ($moduleMeta['version'] ?? null) === '0.10.28');
...
expectTrue('composer version matches module', ($composer['version'] ?? null) === '0.10.28');
expectTrue(
...
expectTrue('listPublic self chips include hold', str_contains($jobService, "'hold' => \$hasHold"));
