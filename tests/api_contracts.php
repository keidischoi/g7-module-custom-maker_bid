...
expectTrue('admin settings read permission', str_contains($api, 'permission:admin,custom-maker_bid.settings.read'));
expectTrue('admin settings update permission', str_contains($api, 'permission:admin,custom-maker_bid.settings.update'));
...
expectTrue('module version is 0.7.2', str_contains($moduleJson, '"version": "0.7.2"'));
