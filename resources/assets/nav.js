(function () {
  ...
  function hideExt(menu) {
    if (menu && menu.extension_user_base === false) {
      document.querySelectorAll('.cmb-ext-user-base, #maker_bid_user_nav').forEach(function (el) {
        el.style.display = 'none';
      });
    }
    if (menu && menu.extension_home === false) {
      document.querySelectorAll('.cmb-ext-home, #maker_bid_home_nav').forEach(function (el) {
        el.style.display = 'none';
      });
    }
  }
